...
from videox_fun.utils.utils import (filter_kwargs, get_image_to_video_latent,
                                   save_videos_grid)
from timadapter.tools.process_video_frames import process_video_frames_2_dir
...
def main(args):
    ...
    print("prompt list is: " + str(prompt_list) + "\n")
    ...
    with torch.no_grad():
        ...
        for prompt, video_path in zip(prompt_list, video_list):
            print("prompt is: " + prompt + "\n")
            validation_image_start, sample_size = process_video_frames_2_dir(video_path, args.sample_size, True)
            ...
            print("clip image is: " + str([clip_image.size[1], clip_image.size[0]]))
            ...
            if args.ulysses_degree * args.ring_degree > 1:
                ...
                if dist.get_rank() == 0:
                    ...
                    shutil.move(validation_image_start, save_path)
        ...
        if args.lora_path is not None:
            pipeline = unmerge_lora(pipeline, args.lora_path, args.lora_weight)
