...
accelerate launch --use_deepspeed --deepspeed_multinode_launcher standard  \
   timadapter/scripts/wan2.1_fun/train_reward_lora_i2v_14B_zero3.py \
   ...
   --learning_rate=1e-05 \
   --seed=42 \
   --output_dir="output/Fun_14B/I2V_HPSReward" \
